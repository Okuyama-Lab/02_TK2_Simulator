...
% Outputs orbit-wise and time-resolved power data for various efficiency rates.
...
function Caluc_PowerGeneration(data, DT)
    ...
    parfor idx = 1:length(eff_range)
        ...
        eff_str = sprintf('%.0f', Generation_Efficiency*100);  % 例: '90'
        filename = ['Power_' eff_str '%.xlsx'];
        fullfile_out = fullfile(outdir, filename);
