function Calc_PowerGeneration(data, DT)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    parfor idx = 1:length(eff_range)
        ...
        Pow_x_pos(x_pos) =  Vec_x(x_pos) * Pos_x * scale;
        Pow_x_neg(x_neg) = -Vec_x(x_neg) * Neg_x * scale;

        Pow_y_pos(y_pos) =  Vec_y(y_pos) * Pos_y * scale;
        Pow_y_neg(y_neg) = -Vec_y(y_neg) * Neg_y * scale;

        Pow_z_pos(z_pos) =  Vec_z(z_pos) * Pos_z * scale;
        Pow_z_neg(z_neg) = -Vec_z(z_neg) * Neg_z * scale;
